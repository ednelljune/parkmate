# Victoria Public Parking By Suburb Research (2026-04-17)
...
- Vicmap Features of Interest parking areas: https://services-ap1.arcgis.com/P744lA0wf4LlBZ84/ArcGIS/rest/services/Vicmap_Features_of_Interest/FeatureServer/4/query

## Results

- Official Victoria localities processed: 2,973
- Parking entities exported: 33,504
- Entities matched to an official locality: 33,490
- Entities not matched to a locality: 14
- Localities with at least one gathered public parking entity: 95
...
- Department of Transport and Planning: 393 entities across 56 matched localities

## Notes

- `victoria-public-parking-zones-by-suburb-<date>.csv` is the detailed export. Ballarat rows include zone polygons and meter points, Casey rows are restriction segments, Geelong rows are lot references, Melbourne rows include both parking zones reconstructed from zone-to-segment links and live bay or sensor reference points, and Vicmap rows add statewide parking-area centroid features.
