...
svg_template = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="512" height="512">
  ...
  <g clip-path="url(#iconClip)">
    ...
    <g>
      <animateMotion path="M 128 276 Q 76 192 128 128 T 128 -20" rotate="auto" begin="0s" dur="4s" keyTimes="0; 1" keyPoints="0; 1" calcMode="linear" repeatCount="indefinite" />
...
with open('scratch/middle_logo.svg', 'w') as f:
    f.write(svg_template)

print("Generated scratch/middle_logo.svg")
