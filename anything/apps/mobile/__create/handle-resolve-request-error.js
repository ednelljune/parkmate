...
const handleResolveRequestError = ({ error, context, moduleName, platform }) => {
  ...
  // Returning dynamically-created virtual files is unreliable on native Metro on Windows,
  // because the file map may not watch them early enough to compute SHA-1 hashes.
  // Surface the original resolution error directly for native platforms instead.
